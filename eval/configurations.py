...
def configurations():
    ...
    return [
        ...
        variant("scoped_single_pass",**baseline,initial="scoped",representation="pipe",drill_down=False,verification="none"),
        variant("demo_style_react",**baseline,initial="scoped",representation="pipe",verification="existence"),
        variant("v2_no_semantic",semantic=False),
        v2,
        *(variant("v2_"+representation,representation=representation) for representation in ("raw","pipe","typed_json","typed_edges")),
